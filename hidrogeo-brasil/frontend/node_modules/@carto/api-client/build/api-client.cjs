...
var WidgetTilesetSource = class extends WidgetSource {
  constructor(props) {
    ...
    this._workerEnabled = (props.widgetWorker ?? true) && false;
...
// src/fetch-map/layer-map.ts
var SCALE_FUNCS = {
  linear: import_d3_scale.scaleLinear,
  ordinal: import_d3_scale.scaleOrdinal,
  log: import_d3_scale.scaleLog,
  point: import_d3_scale.scalePoint,
  quantile: import_d3_scale.scaleQuantile,
  quantize: import_d3_scale.scaleQuantize,
  sqrt: import_d3_scale.scaleSqrt,
  custom: import_d3_scale.scaleThreshold,
