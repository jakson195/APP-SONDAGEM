...
declare function getColorAccessor({ name, colorColumn, accessorKey }: VisualChannelField, scaleType: ScaleType, { aggregation, range, domainOverride, }: {
    aggregation?: string;
    range: ColorRange;
...
declare function calculateLayerScale(name: string, scaleType: ScaleType, range: ColorRange, data: TilejsonResult, domainOverride?: [number, number]): {
    scale: D3Scale;
...
declare function getSizeAccessor({ name, accessorKey }: VisualChannelField, scaleType: ScaleType | undefined, aggregation: string | null | undefined, range: number[] | undefined, data: TilejsonResult, domainOverride?: [number, number]): {
    accessor: any;
    domain: number[];
    scaleDomain: number[];
...
declare function compileCustomAggregation(exp: string, opts: {
